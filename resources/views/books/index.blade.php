                    ...
                    <div class="hidden md:block">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Vendes</th>
                            ...
                            @forelse($books as $book)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $book->vendes }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $book->categoria ?? 'No especificada' }}</td>
                                ...
                                <li class="py-4 flex flex-col">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex space-x-2">
                                            <a class="bg-yellow-500 hover:bg-yellow-700 text-white font-semibold py-1 px-2 rounded" href="{{ route('books.edit', $book->id) }}">Edit</a>
                                            <a class="bg-red-500 hover:bg-red-700 text-white font-semibold py-1 px-2 rounded" href="{{ route('books.delete', $book->id) }}">Delete</a>
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        ...
                                        <p class="text-sm text-gray-900"><strong>Vendes:</strong> {{ $book->vendes }}</p>
                                        <p class="text-sm text-gray-900"><strong>Categoria:</strong> {{ $book->categoria ?? 'No especificada' }}</p>
                                    </div>
                                </li>
                            @empty
