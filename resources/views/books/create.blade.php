            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="vendes" id="vendes" placeholder="vendes" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    <!-- Afegit el camp de Categoria -->
                    <div class="mb-4">
                        <label for="categoria" class="block text-gray-700">Categoria:</label>
                        <input type="text" name="categoria" id="categoria" placeholder="categoria" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
